...
from util.MF_dataset_rgb import MF_dataset
from util.util import compute_results, visualize
from sklearn.metrics import confusion_matrix
from model.resnet__ import Resnet_for_segmentation
...
parser.add_argument('--weight_name', '-w', type=str, default='resnet')
...
parser.add_argument('--model', '-md', type=str, default='resnet')

args = parser.parse_args()
#############################################################################################
def setting_model(model_name, num_classes=args.n_class, input_channels=3):
    if model_name == 'resnet':
        model = Resnet_for_segmentation()
...
if __name__ == '__main__':
    ...
    model = setting_model(args.model)
